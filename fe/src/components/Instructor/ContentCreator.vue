<template>
    <div class="content-creator">
        <div class="creator-header">
            ...
            <div class="creator-nav">
                ...
                <button 
                    ...
                    :class="['nav-btn', { active: activeTab === 'bank' }]"
                >
                ...
                <button 
                    ...
                    :class="['nav-btn', { active: activeTab === 'runner' }]"
                >
        ...
        <div v-if="activeTab === 'bank'" class="tab-content">
            <QuestionBank @edit-question="editQuestionFromBank" @duplicate-question="duplicateQuestionFromBank" />
        </div>

        <!-- Tab Code Runner -->
        <div v-if="activeTab === 'runner'" class="tab-content">
            <CodeRunner :problem="selectedProblem" @next-problem="loadNextProblem" />
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            // Selected problem for code runner
            selectedProblem: {
                id: 1,
                title: 'Two Sum',
                difficulty: 'easy',
    ...
    methods: {
        ...
        loadNextProblem() {
            // Load next problem for code runner
